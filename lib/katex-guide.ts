...
export const guideItems: GuideItem[] = [
  {
    ...
    description: "計算メモで使用できる、KaTeX表示専用のブロックです。数式を見せるための機能であり、値の計算や結果生成は行いません。",
    previewType: "katex",
  },
  {
    category: "ブロック",
    name: "計算ブロック",
    latex: "200*(5%+5%)",
    description: "計算メモで使用できるブロックです。電卓と同じ計算エンジンで式を評価し、入力欄と結果をセットで保存・表示します。不正な式はそのブロック内だけにエラー表示されます。",
